...
- [aqstack/sentinel](https://github.com/aqstack/sentinel) (365 Go) - Sentinel is an AI-powered self-healing edge computing agent for Kubernetes that predicts failures, enables autonomous operation during network partitions, and orchestrates workload migrations to enhance edge node reliability and resilience.
